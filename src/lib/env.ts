...
const envSchema = z.object({
  ...
  DATABASE_URL: z.string().default("postgresql://postgres:postgres@localhost:5432/x402-concerts"),
  ...
  SPOTIFY_REDIRECT_URI: z.url().default("http://localhost:3000/api/v1/link/callback"),
  ...
  X402_NETWORK: z.enum(["base:mainnet", "base:testnet"]).default("base:mainnet"),
